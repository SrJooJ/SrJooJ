...
```yaml
nome: João Cruz
cargo: Tech Manager @ Growth 7
experiencia: 3 anos hands-on em tecnologia
formacao:
  - Engenharia da Computação - USJT
  - MBA Engenharia de Dados - FIAP (em andamento)
foco: 
  - Data Engineering
...
📝 **Meu artigo científico:** [IA e Cibersegurança: Análise de Ameaças Emergentes e Estratégias Defensivas](https://ojs.revistadelos.com/ojs/index.php/delos/article/view/2954)
...
<table>
  <tr>
    ...
    <td align="center" width="50%">
      <h3>🌐 Tradução com IA</h3>
      <p>Sistema de tradução juramentada PT→IT para documentos legais</p>
      <p><strong>Economia: ~R$1M/ano</strong></p>
      <p><code>DeepL API</code> <code>TypeScript</code> <code>Docker</code></p>
    </td>
  </tr>
  <tr>
    <td align="center" width="50%">
      <h3>🤖 Feedback com IA</h3>
      <p>Agente que analisa conversas de vendas e gera relatórios automáticos</p>
      <p><code>LangGraph</code> <code>Python</code> <code>Docker</code></p>
    </td>
    <td align="center" width="50%">
      <h3>📊 CRM Bitrix24</h3>
      <p>Implementação completa do zero até adoção</p>
      <p><code>Bitrix24</code> <code>Automações</code> <code>API</code></p>
    </td>
  </tr>
</table>
